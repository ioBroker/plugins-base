...
class PluginBase {
    ...
    constructor(settings) {
        ...
        this.pluginNamespace = settings.pluginNamespace; // e.g. "system.adapter.name.instance.plugins." or "system.host.name."
            ...
            this.extendObject(this.pluginNamespace + '.enabled', {
                ...
                this.getState(this.pluginNamespace + '.enabled', (err, state) => {
                    ...
                    if (active) {
                        ...
                        this.init(pluginConfig, callback);
                    } else {
